...
<head>
  ...
  <style>
    ...
    .form {
      ...
      border: 8px solid #fff; /* increased border size */
      background: rgba(0, 255, 240, 0.52);
      box-shadow: 0px 0px 128px 0px #82e1ff inset, 0px 0px 32px #a8fffaa6;
      backdrop-filter: blur(7px); /* increased blur */
    ...
    #login-lable {
      ...
      font-weight: 600;
      letter-spacing: 16px; /* increased letter spacing */
      text-shadow: 0px 0px 32px rgb(243, 243, 243);
    }
    ...
    .form-content {
      ...
      border: 4px solid #fff; /* increased border size */
      background: rgba(139, 255, 247, 0.486);
      box-shadow: 0px 0px 2px 6px #9ee5e3 inset, 0px 8px 8px 0px #181a6040;
      text-shadow: 0px 2px 8px rgb(243, 243, 243);
      font-size:30px;
    }
    ...
    .form-content:focus-visible {
      ...
      box-shadow: 0px 0px 2px 8px #9ee5e3;
    }
    ...
    ::placeholder {
      font-weight: 300;
      color: white;
      letter-spacing: 0.2rem; /* increased letter spacing */
      text-shadow: 0px 2px 10px rgb(66, 66, 66);
    }
    ...
    .form button {
      ...
      color: white;
      font-size: 36px; /* increased font size */
      letter-spacing: 0.6rem; /* increased letter spacing */
    ...
    .form button:hover {
      position: relative;
      bottom: 8px; /* increased bottom spacing */
    ...
    @keyframes float {
      ...
      50% {
        top: 100px; /* increased top spacing */
      }
...
<div id="Container">
  <form action="" class="form" method="post">
    <div id="login-lable">Gift</div>
    <input class="form-content" type="text" placeholder="Mj Hyacinth B. De Juan" disabled/>
    <input class="form-content" name="password" type="password" placeholder="PassWord" />
